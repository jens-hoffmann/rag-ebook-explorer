...
@router.get(
    ...
    description="Get a list of all books currently indexed in the database.",
)
async def list_books(
    ...
    books_data = await indexing_service.list_books()
...
@router.delete(
    ...
    description="Remove all chunks of a book from the database.",
)
async def delete_book(
    ...
    deleted = await indexing_service.delete_book(book_id)
